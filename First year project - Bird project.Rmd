...
m7 <- lm(formula = Time ~ Pairs + Size + Status + Pairs*Size + Pairs*Status, data)     
m8 <- lm(formula = log(Time) ~ Pairs + Size + Status + Pairs*Size + Pairs*Status + Pairs*Size*Status + Size*Status, data)
m9 <- lm(formula = log(Time) ~ Pairs + Size + Status + Pairs*Size + Pairs*Status + Pairs*Size*Status, data)
